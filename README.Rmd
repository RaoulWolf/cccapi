...
This is an example which shows you how to get the record details for a CAS Registry Number. In this case, for aspirin:
...
Here is an example which shows you how to get the SDF file for a CAS Registry Number. In this case, again, for aspirin:
